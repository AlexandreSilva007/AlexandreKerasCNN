...
class CustomCallback(keras.callbacks.Callback):
  ...
  def on_epoch_end(self, epoch, logs={}):
    ...
    #print(val_targ)
    _val_f1 = f1_score(val_targ, val_predict, average=None,  normalize=False)
    _val_recall = recall_score(val_targ, val_predict,average=None,  normalize=False)
    _val_precision = precision_score(val_targ, val_predict,average=None,  normalize=False)
